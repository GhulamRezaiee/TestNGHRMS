...
public class Listener implements ITestListener {
	@Override
	public void onStart(ITestContext context) {//this listener execute base on <test> from xml file
	...
	@Override
	public void onTestStart(ITestResult result) {//this listener execute when @Test method starts
